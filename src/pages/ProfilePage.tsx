    ...
    <div className="px-4 sm:px-6 py-4 space-y-5 animate-page-enter">
      ...
      <div className="flex flex-col items-center">
        <div className="relative">
          ...
          <div className="absolute bottom-0 end-0 h-8 w-8 rounded-full bg-rp-card border-2 border-slate-100 dark:border-surface-dark flex items-center justify-center shadow-sm">
