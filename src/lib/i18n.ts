...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'ai.paymentTitle': { en: 'Complete Payment', he: 'השלם תשלום' },
  'ai.paymentDesc': { en: 'This is where you would enter your credit card details.', he: 'כאן תזין את פרטי כרטיס האשראי שלך.' },
  'ai.paymentPlaceholder': { en: 'Stripe payment form will appear here', he: 'טופס תשלום Stripe יופיע כאן' },
  'ai.confirmPayment': { en: 'Confirm & Activate', he: 'אשר והפעל' },
